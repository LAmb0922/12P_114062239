...
from src.scenes.new_battle_scene import NewBattleScene
class Engine:
    ...
    def __init__(self):
        ...
        scene_manager.register_scene("choose",ChooseScene())
        scene_manager.register_scene("new_battle",NewBattleScene())
    def run(self):
