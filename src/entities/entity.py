...
class Entity_one:
    ...
    @classmethod
    def from_dict(cls, data: dict[str, float | int], game_manager: GameManager) -> Entity_one:
        x = float(data["x"])
        y = float(data["y"])
...
class Entity_two:
    ...
    @classmethod
    def from_dict(cls, data: dict[str, float | int], game_manager: GameManager) -> Entity_two:
        x = float(data["x"])
        y = float(data["y"])
        return cls(x * GameSettings.TILE_SIZE, y * GameSettings.TILE_SIZE, game_manager)
class Entity_three:
    ...
    @classmethod
    def from_dict(cls, data: dict[str, float | int], game_manager: GameManager) -> Entity_three:
        x = float(data["x"])
        y = float(data["y"])
        return cls(x * GameSettings.TILE_SIZE, y * GameSettings.TILE_SIZE, game_manager)