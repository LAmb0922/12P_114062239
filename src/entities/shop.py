...
from .entity import Entity_one,Entity_two,Entity_three
...
class ShopClassification(Enum):
    STATIONARY = "stationary"

@dataclass
class IdleMovement:
    def update(self, shop: "Shop", dt: float) -> None:
        return

class Shop(Entity_two):
    ...
    def __init__(
        ...
        classification: ShopClassification = ShopClassification.STATIONARY,
        ...
        if classification == ShopClassification.STATIONARY:
    ...
    def from_dict(cls, data: dict, game_manager: GameManager) -> "Shop":
        classification = ShopClassification(data.get("classification", "stationary"))
        ...
        if facing_val is not None:
            if isinstance(facing_val, str):
                ...
                facing = facing_val
        if facing is None and classification == ShopClassification.STATIONARY:
